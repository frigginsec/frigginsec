...
Looking at the sender's email, the nam Jonathan Roberts is common enough to not really lead to anything conclusive, and a search for the full email returned no results. This probably another generated account designed to look innocuous enough to pass as a real human sending a legitimate email. 
